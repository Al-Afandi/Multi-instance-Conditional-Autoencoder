    ...
    for epoch in range(num_epochs):
        ...
        if epoch%100==0:
            ...
            for i in range(model.de_num):
                ...
                ax.imshow(x)
                inx+=1
            plt.savefig('./logs/images/samples/cifar10_MIAE_imgs'+str(k)+'_'+str(epoch))

    
p.dump(test_loss_log,open('./logs/images/cifar10_MIAE_test_loss_log','wb'))
p.dump(train_loss_log,open('./logs/images/cifar10_MIAE_train_loss_log','wb'))